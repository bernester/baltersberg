<div class="max-w-screen-sm mx-auto py-8 mb-8">
  <section class="mb-6">
    <h1 class="text-lg font-bold mb-2">Datenschutz&shy;erklärung</h1>
    <p class="text-sm mb-4 text-pretty">
      Wir freuen uns sehr über Ihr Interesse an unserem Zeltlager. Datenschutz
      hat für uns einen besonders hohen Stellenwert und wir nehmen den Schutz
    ...
    <p class="text-sm mb-4 text-pretty">
      ...
      Übereinstimmung mit den für das Zeltlager Baltersberg geltenden
    ...
    <p class="text-sm mb-4 text-pretty">bernesterland@gmail.com</p>
  </section>

  <section class="mb-6">
    <h2 class="font-bold mb-2">Ihre Betroffenenrechte</h2>
    <p class="text-sm mb-4 text-pretty">
      Unter den angegebenen Kontaktdaten können Sie jederzeit folgende Rechte
      ausüben:
    </p>
    <ul class="text-sm mb-4 space-y-1 text-pretty list-outside list-disc ps-4">
      <li>
  ...
  <section class="mb-6">
    <h2 class="font-bold mb-2">Löschung bzw. Sperrung der Daten</h2>
    <p class="text-sm mb-4 text-pretty">
  ...
  <section class="mb-6">
    <h2 class="font-bold mb-2">Beim Besuch der Website</h2>
    <p class="text-sm mb-4 text-pretty">
      ...
      an den Server unserer Webseite gesendet. Diese Informationen werden
      temporär in einem sog. Logfile gespeichert. Folgende Informationen werden
    ...
    <p class="text-sm mb-4 text-pretty">
      ...
      Analyse Dienste ein. Nähere Erläuterungen dazu erhalten Sie unter den
      Ziff. 9 und 10 dieser Datenschutzerklärung.
    </p>
  </section>
  <section class="mb-6">
    <h2 class="font-bold mb-2">Anmeldung auf unserer Internetseite</h2>
    <p class="text-sm mb-4 text-pretty">
      ...
      von Tally https://tally.so/help/privacy-policy
    </p>
    <p class="text-sm mb-4 text-pretty">
      ...
      Daten anzumelden. Welche personenbezogenen Daten dabei an den für die
      Verarbeitung Verantwortlichen übermittelt werden, ergibt sich aus der
      jeweiligen Eingabemaske, die für die Anmeldung verwendet wird.
    </p>
    <p class="text-sm mb-4 text-pretty">
      Die von der betroffenen Person eingegebenen personenbezogenen Daten werden
      ausschließlich für die interne Verwendung bei den für die Verarbeitung
    ...
    <p class="text-sm mb-4 text-pretty">
      Durch eine Anmeldung auf der Internetseite des für die Verarbeitung
      ...
      Anmeldung gespeichert. Die Speicherung dieser Daten erfolgt vor dem
      ...
      für die Verarbeitung Verantwortlichen erforderlich.
    </p>
    <p class="text-sm mb-4 text-pretty">
      Eine Weitergabe dieser Daten an Dritte erfolgt grundsätzlich nicht, sofern
      keine gesetzliche Pflicht zur Weitergabe besteht oder die Weitergabe der
      Strafverfolgung dient. Die Anmeldung der betroffenen Person unter
      ...
      anzubieten, die aufgrund der Natur der Sache nur angemeldeten Benutzern
      angeboten werden können.
    </p>
    <p class="text-sm mb-4 text-pretty">
      Angemeldeten Personen steht die Möglichkeit frei, die bei der Anmeldung
      angegebenen personenbezogenen Daten jederzeit abzuändern oder vollständig
      aus dem Datenbestand des für die Verarbeitung Verantwortlichen löschen zu
      lassen. Der für die Verarbeitung Verantwortliche erteilt jeder betroffenen
      Person jederzeit auf Anfrage Auskunft darüber, welche personenbezogenen
      Daten über die betroffene Person gespeichert sind. Ferner berichtigt oder
    ...
    <p class="text-sm mb-4 text-pretty">
      Ein in dieser Datenschutzerklärung namentlich benannter
      Datenschutzbeauftragter und die Gesamtheit der Mitarbeiter des für die
      Verarbeitung Verantwortlichen stehen der betroffenen Person in diesem
      Zusammenhang als Ansprechpartner zur Verfügung.
    </p>
  </section>
  <section class="mb-6">
    <h2 class="font-bold mb-2">Datensicherheit</h2>
    <p class="text-sm mb-4 text-pretty">
  ...
  <section class="mb-6">
    <h2 class="font-bold mb-2">Fragen an den Datenschutzbeauftragten</h2>
    <p class="text-sm mb-4 text-pretty">
