<div class="content">
  ...
  <p>
    ...
    Manipulationen, Verlust, Zerstörung oder den Zugriff unberechtigter Personen
  ...
  <p>
    ...
    dem Bundesland Ihres Wohnsitzes, Ihrer Arbeit oder der mutmaßlichen
  ...
  <p>
    ...
    an den Server unserer Webseite gesendet. Diese Informationen werden temporär
    in einem sog. Logfile gespeichert. Folgende Informationen werden dabei ohne
  ...
  <p>
    ...
    DS-GVO. Unser berechtigtes Interesse folgt aus oben aufgelisteten Zwecken
    zur Datenerhebung. In keinem Fall verwenden wir die erhobenen Daten zu dem
    Zweck, Rückschlüsse auf Ihre Person zu ziehen.
  </p>
  <p>
    Darüber hinaus setzen wir beim Besuch unserer Website Cookies sowie Analyse
    Dienste ein. Nähere Erläuterungen dazu erhalten Sie unter den Ziff. 9 und 10
    dieser Datenschutzerklärung.
  </p>
  ...
  <p>
    ...
    Verantwortlichen und für eigene Zwecke erhoben und gespeichert. Der für die
  ...
  <p>
    ...
    keine 256-Bit-Verschlüsselung unterstützt, greifen wir stattdessen auf
